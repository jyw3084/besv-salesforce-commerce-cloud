 ...
 */
 server.replace(
    ...
    function (req, res, next) {
        ...
        var formEmail = registrationForm.customer.email.value.toLowerCase();
        ...
        if (formEmail && CustomerMgr.getCustomerByLogin(formEmail)) {
            registrationForm.customer.email.valid = false;
            registrationForm.customer.email.error = Resource.msgf('error.message.account.exist', 'forms', null, formEmail);
            registrationForm.valid = false;
        }
